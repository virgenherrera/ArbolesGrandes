...
function WriteToForm( bDisplay, fShipping ) {
   ...
   if ( bDisplay )
      strOutput = "<TABLE CLASS=\"nopcart\"><TR>" +
                  "<TD CLASS=\"nopheader\"><P><B>"+strILabel+"</B></TD>" +
                  "<TD CLASS=\"nopheader\"><P><B>"+strDLabel+"</B></TD>" +
                  "<TD CLASS=\"nopheader\"><P><B>"+strQLabel+"</B></TD>" +
                  "<TD CLASS=\"nopheader\"><P><B>"+strPLabel+"</B></TD>" +
                  (DisplayShippingColumn?"<TD CLASS=\"nopheader\"><P><B>"+strSLabel+"</B></TD>":"") +
                  "<TD CLASS=\"nopheader\"><P><B>"+strRLabel+"</B></TD></TR>";
   ...
   for ( i = 1; i <= iNumberOrdered; i++ ) {
      ...
      if ( bDisplay ) {
         strOutput += "<TR><TD CLASS=\"nopentry\"><P>"  + fields[0] + "</TD>";

         if ( fields[5] == "" )
            strOutput += "<TD CLASS=\"nopentry\"><P>"  + fields[3] + "</TD>";
         else
            strOutput += "<TD CLASS=\"nopentry\"><P>"  + fields[3] + " - <I>"+ fields[5] + "</I></TD>";

         strOutput += "<TD CLASS=\"nopentry\"><P>" + fields[1] + "</TD>" +
                      "<TD CLASS=\"nopentry\"><P>"+ MonetarySymbol + moneyFormat(fields[2]) + "/ea</TD>";

         if ( DisplayShippingColumn ) {
            if ( parseFloat(fields[4]) > 0 )
               strOutput += "<TD CLASS=\"nopentry\"><P>"+ MonetarySymbol + moneyFormat(fields[4]) + "/ea</TD>";
            else
               strOutput += "<TD CLASS=\"nopentry\"><P>N/A</TD>";
         }
   ...
   if ( bDisplay ) {
      strOutput += "<TR><TD CLASS=\"noptotal\" COLSPAN=4><P><B>"+strSUB+"</B></TD>";
      strOutput += "<TD CLASS=\"noptotal\" COLSPAN=2><P><B>" + MonetarySymbol + strTotal + "</B></TD>";
      strOutput += "</TR>";

      if ( DisplayShippingRow ) {
         strOutput += "<TR><TD CLASS=\"noptotal\" COLSPAN=4><P><B>"+strSHIP+"</B></TD>";
         strOutput += "<TD CLASS=\"noptotal\" COLSPAN=2><P><B>" + MonetarySymbol + strShipping + "</B></TD>";
         strOutput += "</TR>";
      }

      if ( DisplayTaxRow ) {
         strOutput += "<TR><TD CLASS=\"noptotal\" COLSPAN=4><P><B>"+strTAX+"</B></TD>";
         strOutput += "<TD CLASS=\"noptotal\" COLSPAN=2><P><B>" + MonetarySymbol + strTax + "</B></TD>";
         strOutput += "</TR>";
      }

      strOutput += "<TR><TD CLASS=\"noptotal\" COLSPAN=4><P><font color=\"\#ff0000\"><B>"+strTOT+"</B></font></TD>";
      strOutput += "<TD CLASS=\"noptotal\" COLSPAN=2><P><font color=\"\#ff0000\"><B>" + MonetarySymbol + moneyFormat((fTotal + fShipping + fTax)) + "</B></font></TD>";
      strOutput += "</TR>";
      strOutput += "</TABLE>";
